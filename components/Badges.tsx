...
const completionMeta: Record<CompletionStatus, { label: string; className: string }> = {
  accepted: { label: '已通過', className: 'border-emerald-400/40 bg-emerald-500/15 text-emerald-300' },
  reviewed: { label: '已複習', className: 'border-blue-400/40 bg-blue-500/15 text-blue-200' },
